...
export default function Auth() {
  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center p-8">
        ...
        >
          ...
          <p className="text-muted-foreground mb-8">
            {isSignUp 
              ? 'Start growing your LinkedIn presence with AI'
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center bg-secondary/30 border-l border-border">
        <motion.div
        ...
        >
          ...
          <p className="text-muted-foreground">
            Generate human-like posts, optimize your profile, and analyze your content for maximum engagement.
          </p>
        </motion.div>
      </div>
    </div>
